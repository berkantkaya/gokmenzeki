      ...
      <div className="w-full md:w-1/2 md:flex md:justify-center">
        <div className="md:flex md:flex-col px-6 py-5 md:px-3 md:py-0 space-y-4">
          ...
          <p className="font-bold">
            GÖKMEN ZEKİ CAM AYNA ALÜMİNYUM RAY KAPAK LTD. ŞTİ.
          </p>
          <p className="text-gray-600">
            Şemikler, 6314. Sk. No:1-1 D:2, 35560 Karşıyaka/İzmir
          </p>

          <p className="flex items-center text-gray-600">
            <BsTelephone className="mr-1" /> +90 (0232) 336 9733
          </p>

          <p className="flex items-center text-gray-600">
            <BsPrinter className="mr-1" /> +90 (0232) 336 9733
          </p>

          <p className="flex items-center text-gray-600">
            <AiOutlineMail className="mr-1" /> bilgi@gokmenzeki.com
          </p>
        </div>
      </div>
      <div className="w-full md:w-1/2 ">
        <div className="block p-6 rounded-lg bg-white max-w-2xl">
